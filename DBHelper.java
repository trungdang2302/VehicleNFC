...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertOrder(double total, int indate, int outdate, int duration, int allowfrom, int allowto, String orderstatusid, String userid, String vehicalname, String vehicalid, String locationid) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();

        contentValues.put(COLUMN_TOTAL, total);
        contentValues.put(COLUMN_CHECK_IN_DATE, indate);
        contentValues.put(COLUMN_CHECK_OUT_DATE, outdate);
        contentValues.put(COLUMN_DURATION, duration);
        contentValues.put(COLUMN_ALLOWED_PARKING_FROM, allowfrom);
        contentValues.put(COLUMN_ALLOWED_PARKING_TO, allowto);
        contentValues.put(COLUMN_TBL_ORDER_STATUS_ID, orderstatusid);
        contentValues.put(COLUMN_TBL_USER_ID, userid);
        contentValues.put(COLUMN_TBL_VEHICAL_NAME, vehicalname);
        contentValues.put(COLUMN_TBL_VEHICAL_ID, vehicalid);
        contentValues.put(COLUMN_TBL_LOCATION_ID, locationid);
